...
const IntercityTrips = () => {
    ...
    const filteredTrips = intercityTrips.filter((trip) => {
        ...
        //filter trip by ID
        const matchesTripByID = tripIDFilter === '' || trip.id.includes(tripIDFilter)
        ...
        return matchesTripByID && matchesStartPoint && matchesEndPoint && matchesDate && matchesStatus 
    })
    .sort((a, b) => {
                ...
                <div className="item-detailed-data-container">
                    ...
                    <div className="item-detailed-data-main">
                        <div className="student-detailed-data-main-firstBox">
                            <div>
                                <h5 style={{marginLeft:'10px',fontWeight:'bold'}}>نوع الحجز</h5>
                                <h5>{selectedTrip.trip_type === 'private' ? 'حوض' : 'نفرات'}</h5>
                            </div>
                            <div>
                                <h5 style={{marginLeft:'10px',fontWeight:'bold'}}>نوع السيارة</h5>
                                <h5>{selectedTrip.car_type}</h5>
                            </div>
                            <div>
                            ...
                            {selectedTrip.trip_type === 'private' && (
                                <div>
                                    <h5 style={{marginLeft:'10px',fontWeight:'bold'}}>عدد الركاب</h5>
                                    <h5>{selectedTrip.riders_number}</h5>
                                </div>
                            )}
                            <div>
                            ...
                            {selectedTrip.trip_type === 'private' && (
                                <div>
                                    <h5 style={{marginLeft:'10px',fontWeight:'bold'}}>المبلغ الجملي</h5>
                                    <h5>{formatTripAmount(selectedTrip.total_price)}</h5>
                                </div>
                            )}
                            <div>
